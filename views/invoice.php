    ...
    <div class="wrapper" style="min-width: 320px;background-color: #f5f7fa;" lang="x-wrapper">
      ...
      <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0"><tr><td style="width: 600px"><![endif]-->
        <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
          <div class="logo-center" style="font-size:0px !important;line-height:0 !important;" align="center" id="emb-email-header"><img style="height: auto;width: 100%;border: 0;max-width: 190px;" src="images/logo.png" alt="" width="190" /></div>
        </div>
      <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
      </div>
      ...
      <p class="size-30" style="Margin-top: 0;Margin-bottom: 20px;font-size: 26px;line-height: 34px;" lang="x-size-30">Payment Receipt</p>
    </div>
        
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <p class="size-24" style="Margin-top: 0;Margin-bottom: 0;font-size: 20px;line-height: 28px;" lang="x-size-24">#{{number}}</p><p class="size-12" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 12px;line-height: 19px;" lang="x-size-12">JUN&nbsp;08 2016</p>
    </div>
      ...
      <p style="Margin-top: 0;Margin-bottom: 0;text-align: center;"><span style="color:#afb3b8">&nbsp; &nbsp; &nbsp; Product &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Price</span></p><p style="Margin-top: 20px;Margin-bottom: 0;text-align: center;"><span style="color:#363636"><strong>HP Laptop</strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;$199 &nbsp;&nbsp;</span></p><p style="Margin-top: 20px;Margin-bottom: 0;text-align: center;">&nbsp;</p>
    </div>
